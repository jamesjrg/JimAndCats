...
let commandTests =
    testList "Command integration tests"
        ...
        testCase "Should be able to create a user" (fun () ->
            ...
            let actual = (run_with' (webApp commandAppService queryAppService)) |> req HttpMethod.POST "/users/create" (Some postData)
        ...
        testCase "Should be able to rename a user" (fun () ->
            ...
            let actual = (run_with' (webApp commandAppService queryAppService)) |> req HttpMethod.PUT "/users/3C71C09A-2902-4682-B8AB-663432C8867B/name" (Some postData)
        ...
        testCase "Should be able to change email address" (fun () ->
            ...
            let actual = (run_with' (webApp commandAppService queryAppService)) |> req HttpMethod.PUT "/users/3C71C09A-2902-4682-B8AB-663432C8867B/email" (Some postData)
        ...
        testCase "Should be able to change password" (fun () ->
            ...
            let actual = (run_with' (webApp commandAppService queryAppService)) |> req HttpMethod.PUT "/users/3C71C09A-2902-4682-B8AB-663432C8867B/password" (Some postData)
