...
let queryTests =
    testList "Query web API tests"
        ...
        testCase "Should be able to fetch a CAT" (fun () ->
            let actual = get getWebServerWithACat "/cats/3C71C09A-2902-4682-B8AB-663432C8867B" None contentString
        ...
        testCase "Should get 404 for non-existent CAT" (fun () ->
            let actual = get getWebServerWithNoEvents "/cats/3C71C09A-2902-4682-B8AB-663432C8867B" None statusCode
